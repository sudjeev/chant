...
{
    //add parse
    [Parse setApplicationId:@"NINpLLSg4MBRY9r4dj7Mj3oepmQyb2OZE21KXI2l"
                  clientKey:@"xlXjDjAik9UvYZ4VOeYrsYjnqjga8nKYPRjtbYUd"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Chant" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Chant.sqlite"];
